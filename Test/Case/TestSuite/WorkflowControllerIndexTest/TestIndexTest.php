<?php
/**
 * WorkflowControllerIndexTest::testIndex()のテスト
 *
 ...
 */
class TestSuiteWorkflowControllerIndexTestTestIndexTest extends NetCommonsControllerTestCase {
 ...
 */
	public function testTestIndex() {
		...
		//テスト実施
		$result = $this->TestSuite->testIndex($urlOptions, $assert, $exception, $return);
