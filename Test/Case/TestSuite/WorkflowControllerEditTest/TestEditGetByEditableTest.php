<?php
/**
 * WorkflowControllerEditTest::testEditGetByEditable()のテスト
 *
 ...
 */
class TestSuiteWorkflowControllerEditTestTestEditGetByEditableTest extends NetCommonsControllerTestCase {
...
/**
 * testEditGetByEditable()のテスト
 *
 * @return void
 */
	public function testTestEditGetByEditable() {
		//データ生成
		$urlOptions = array();
		...
		//テスト実施
		$result = $this->TestSuite->testEditGetByEditable($urlOptions, $assert, $exception, $return);
